...
class MNIST(DatasetBase):
    def __init__(self, scenario, params):
        ...
        super(MNIST, self).__init__(dataset, scenario, num_tasks, params.num_runs, params)


    def download_load(self):
        dataset_train = datasets.MNIST(root=self.root, train=True, download=True)
        self.train_data = dataset_train.data
        self.train_label = np.array(dataset_train.targets)
        dataset_test = datasets.MNIST(root=self.root, train=False, download=True)
